...
//  window.focus()  // it is used to focus to that current window and because of policies it only work on the windows you created aka new window generated by ".open()" method (still not 100% reliable)
