...
//  window.focus()  // it is used to focus to that current window aka Makes a request to bring the window to the front. and because of policies it only work on the windows you created aka new window generated by ".open()" method (still not 100% reliable because of how user settings on the system)
